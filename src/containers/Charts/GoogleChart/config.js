...
const BarChart = {
  ...
  data: [
    ...
    ["2013", 41500, "fill-color: #f64744; fill-opacity: 0.4"],
    ["2016", 76598, "fill-color: #ffbf00; fill-opacity: 0.4"],
    ["2019", 125256, "fill-color: #511E78; fill-opacity: 0.4"],
  ],
  options: {
    title: "2010年至2019年的兌換統計數量",
    titleTextStyle: {
      color: "#788195",
    },
    bar: {
...
const Histogram = {
  ...
  data: [
    ["恐龍", "長度"],
    ["棘龍 (top-spined lizard)", 12.2],
    ["阿爾伯特龍 (Alberta lizard)", 9.1],
    ["異龍 (other lizard)", 12.2],
    ["雷龍 (deceptive lizard)", 22.9],
    ["始祖鳥 (ancient wing)", 0.9],
    ["阿根廷龍 (Argentina lizard)", 36.6],
    ["重爪龍屬 (heavy claws)", 9.1],
    ["腕龍 (arm lizard)", 30.5],
    ["角龍 (horned lizard)", 6.1],
    ["腔骨龍屬 (hollow form)", 2.7],
    ["美頜龍 (elegant jaw)", 0.9],
    ["恐爪龍 (terrible claw)", 2.7],
    ["梁龍 (double beam)", 27.1],
    ["似鴯鶓龍 (emu mimic)", 3.4],
    ["似雞龍 (fowl mimic)", 5.5],
    ["馬門溪龍 (Mamenchi lizard)", 21],
    ["斑龍 (big lizard)", 7.9],
    ["小獵龍 (small hunter)", 1.2],
    ["似鳥龍 (bird mimic)", 4.6],
    ["偷蛋龍 (egg robber)", 1.5],
    ["板龍 (flat lizard)", 7.9],
    ["蜥鳥龍 (narrow-clawed lizard)", 2],
    ["震龍 (tremor lizard)", 45.7],
    ["棘龍 (spiny lizard)", 12.2],
    ["超龍 (super lizard)", 30.5],
    ["暴龍 (tyrant lizard)", 15.2],
    ["極龍 (ultra lizard)", 30.5],
    ["伶盜龍 (swift robber)", 1.8],
  ],
  options: {
    title: "商品兌換排行(件數)",
    titleTextStyle: {
