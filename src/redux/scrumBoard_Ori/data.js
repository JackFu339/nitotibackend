const initialData = {
  tasks: {
    "task-1": {
      ...
      due_date: "2020-01-01",
      image: "../../../images/background/c5.png",
      assignees: ["mark"],
      attachments: [],
      comments: [],
      todos: [],
    ...
    "task-2": {
      ...
      due_date: "2019-01-01",
      image: "../../../images/background/c4.png",
      assignees: [],
      attachments: [],
      comments: [],
      todos: [],
    ...
    "task-3": {
      ...
      due_date: "2019-01-01",
      image: "../../../images/background/c3.png",
    ...
    "task-4": {
      ...
      due_date: "2019-01-01",
      image: "../../../images/background/c1.png",
      assignees: [],
      attachments: [],
      comments: [],
      todos: [],
    ...
    "task-5": {
      ...
      due_date: "2020-01-01",
      image: "../../../images/background/c2.png",
      assignees: ["bob"],
      attachments: [],
      comments: [],
      todos: [],
  ...
  boards: {
    ...
    "board-3": {
      id: "board-3",
      column_orders: ["column-1", "column-2", "column-3"],
      title: "關於我們",
      category: "軟體",
      progress: 30,
      thumb: "",
